...
Class Encomiendas
{
	...
	public function insertar($guia,$nombre_completo,$nombre_re,$carnet,$expedido,$celular,$celular2,$fecha,$origen,$destino,$precio,$detalle,$chofer)
	{
		$sql="INSERT INTO encomiendas (guia,nombre_completo,nombre_re,carnet,expedido,celular,celular2,fecha,origen,destino,precio,detalle,chofer,condicion)
		VALUES ('$guia','$nombre_completo','$nombre_re','$carnet','$expedido','$celular','$celular2','$fecha','$origen','$destino','$precio','$detalle','$chofer','1')";
		return ejecutarConsulta($sql);
	}

	//Implementamos un método para editar registros
	public function editar($guia,$nombre_completo,$nombre_re,$carnet,$expedido,$celular,$celular2,$fecha,$origen,$destino,$precio,$detalle,$chofer)
	{
	...
	{
		$sql="SELECT guia,nombre_completo,nombre_re,carnet,expedido,celular,celular2,fecha,origen,destino,precio,detalle,chofer,condicion FROM encomiendas ";
		return ejecutarConsulta($sql);		
	}
